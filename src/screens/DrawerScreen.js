...
import {days, hours} from './drawer/arrays';
import {colors, constant} from './drawer/constant';
  ...
  return (
    <DrawerView style={styles.container}>
      <StatusBar
        ...
        backgroundColor={
          isDrawerOpen === 'open' ? colors.sceneBg : colors.screenBg
        }
      />
              ...
              <View style={styles.status}>
                <View style={styles.chip}>
                  ...
                  <Text
                    style={[
                      styles.text,
                      {marginHorizontal: constant.SPACING / 3},
                    ]}>
                    12%
                  </Text>
                </View>
